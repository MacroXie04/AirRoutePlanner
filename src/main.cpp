...
int main() {
    ...
    // Result display - use Fl_Multiline_Output for non-editable, non-selectable text
    Fl_Box* resultLabel = new Fl_Box(20, 260, 260, 20, "Itinerary Details:");
    resultLabel->align(FL_ALIGN_LEFT | FL_ALIGN_INSIDE);
    
    Fl_Multiline_Output* resultOutput = new Fl_Multiline_Output(20, 280, 260, 340);
    ...
    Fl_Box* addAirportLabel = new Fl_Box(1000, 380, 260, 20, "Add / Edit Airport:");
    ...
    Button* loadAirportBtn = new Button(1000, 500, 250, 25, "Load Selected for Editing");
    ...
    Button* loadRouteBtn = new Button(1000, 595, 250, 25, "Load Selected for Editing");
    ...
    setupAirportCallbacks(addAirportBtn, editAirportBtn, delAirportBtn, loadAirportBtn,
                          newCode, newName, newX, newY);
